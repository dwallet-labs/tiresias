...
mod tests {
    ...
    #[case::panic_zero_a(
    NonZero::new(PaillierModulusSizedNumber::ZERO).unwrap(),
    NonZero::new(PaillierModulusSizedNumber::ONE).unwrap()
    )]
    #[should_panic(expected = "assertion failed: `(left == right)")]
    #[case::panic_zero_b(
    NonZero::new(PaillierModulusSizedNumber::ONE).unwrap(),
    ...
    fn cannot_construct_proof_with_zero(
        #[case] a: NonZero<PaillierModulusSizedNumber>,
        #[case] b: NonZero<PaillierModulusSizedNumber>,
    ) {
        let _ = ProofOfEqualityOfDiscreteLogs {
            a,
            b,
    ...
    #[test]
    fn valid_proof_alter_field_fails() {
        let a = U4096::from_be_hex("");
        let b = U4096::from_be_hex("");
        let g_hat = U4096::from_be_hex("");
        let h_hat = U4096::from_be_hex("");
