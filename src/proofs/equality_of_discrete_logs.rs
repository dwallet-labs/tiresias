...
pub struct ProofOfEqualityOfDiscreteLogs {
    base_randomizer: PaillierModulusSizedNumber, // The base randomizer $\hat{g} \in \mathbb{Z}_{N^2}$.
    ciphertext_randomizer: PaillierModulusSizedNumber, // The ciphertext randomizer $\hat{h} \in \mathbb{Z}_{N^2}$.
