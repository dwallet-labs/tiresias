...
pub struct ProofOfEqualityOfDiscreteLogs {
    ...
    ciphertext_squared_randomizer: PaillierModulusSizedNumber,
...
mod tests {
    ...
    fn invalid_proof_fails_verification() {
        ...
        let wrong_base_squared_randomizer = PaillierModulusSizedNumber::from_be_hex("");
        let wrong_ciphertext_squared_randomizer = PaillierModulusSizedNumber::from_be_hex("");
        ...
        let invalid_proof = ProofOfEqualityOfDiscreteLogs {
            base_squared_randomizer: wrong_base_squared_randomizer,
            ciphertext_squared_randomizer: wrong_ciphertext_squared_randomizer,
        ...
        let crafted_proof = ProofOfEqualityOfDiscreteLogs {
            base_squared_randomizer: PaillierModulusSizedNumber::ZERO,
            ciphertext_squared_randomizer: PaillierModulusSizedNumber::ZERO,
            response: wrong_response,
        };
        ...
        // Try to fool verification with fields zero mod N^2
        let crafted_proof = ProofOfEqualityOfDiscreteLogs {
            base_squared_randomizer: N.into(),
            ciphertext_squared_randomizer: N.into(),
            response: wrong_response,
        };
        ...
        // Assure that verification fails if any statement equals (a multiple of) N
        assert!(crafted_proof
            .verify(
                &N,
                &BASE,
                &CIPHERTEXT,
                &(N * LargeBiPrimeSizedNumber::from(2u8)), // try also a multiple of N, and not only N
                &N.into(),
            )
            .is_err());
        ...
        invalid_proof.base_squared_randomizer = wrong_base_squared_randomizer;
        assert!(invalid_proof
            .verify(
                &N,
                &BASE,
        ...
        invalid_proof.ciphertext_squared_randomizer = wrong_ciphertext_squared_randomizer;
        assert!(invalid_proof
            .verify(
                &N,
                &BASE,
