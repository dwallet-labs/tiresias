...
mod tests {
    ...
    fn decrypts(#[case] t: u16, #[case] n: u16, #[case] batch_size: usize) {
        ...
        // DKG.
        let phi = (P.wrapping_sub(&LargePrimeSizedNumber::ONE))
...
mod benches {
    ...
    pub(crate) fn benchmark_decryption_share(c: &mut Criterion) {
        ...
        let p = LargePrimeSizedNumber::from_be_hex("");
        let q = LargePrimeSizedNumber::from_be_hex("");
        let n2 = n.square();
        ...
        for num_parties in [10, 100, 1000, 10000] {
            let precomputed_values = PrecomputedValues::new(num_parties, encryption_key.n);
