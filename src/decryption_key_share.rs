...
pub mod test_exports {
    ...
    pub fn deal_trusted_shares(t: PartyID, n: PartyID) -> (PublicParameters, HashMap<PartyID, DecryptionKeyShare>) {
    ...
    fn generates_decryption_share() {
        ...
        let (public_parameters, decryption_key_shares) = deal_trusted_shares(t, n);
